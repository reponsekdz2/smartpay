        ...
        return (
          <form onSubmit={handlePhoneSubmit} className="space-y-6">
            <div className='text-center'>
              ...
              <p className="text-text-secondary">Enter your phone number to get started.</p>
            </div>
      ...
      case 2:
        return (
          <form onSubmit={handleCodeSubmit} className="space-y-6">
            <div className='text-center'>
              <h2 className="text-2xl font-bold text-text-primary">Verify Your Number</h2>
              <p className="text-text-secondary">We've sent a code to {phone}. (Hint: 458392)</p>
            </div>
      ...
      case 3:
        return (
          <form onSubmit={handlePinSubmit} className="space-y-6">
            <div className='text-center'>
              <h2 className="text-2xl font-bold text-text-primary">Create a PIN</h2>
              <p className="text-text-secondary">Create a secure 6-digit PIN for your account.</p>
            </div>
       ...
       case 4:
        return (
          <form onSubmit={handleKycSubmit} className="space-y-6">
            <div className='text-center'>
              <h2 className="text-2xl font-bold text-text-primary">Final Step: KYC</h2>
              <p className="text-text-secondary">Please provide your National ID and full name.</p>
            </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-background">
       <div className="w-full max-w-sm mx-auto">
        ...
        <p className="text-center mt-6 text-text-secondary">Already have an account? <button onClick={() => setScreen('LOGIN')} className="font-bold text-primary hover:underline">Log In</button></p>
      </div>
    </div>
  );
};
